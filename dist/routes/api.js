...
apiRoutes.put('/company', auth_1.authenticateToken, (0, auth_1.authorizeRoles)('admin'), companyController_1.updateCompany);
// 3. Produtos (Oncochip)
apiRoutes.get('/products', productController_1.getProducts);
apiRoutes.post('/products', auth_1.authenticateToken, (0, auth_1.authorizeRoles)('admin'), productController_1.createProduct);
// 4. Aplicação do Produto
apiRoutes.get('/applications', applicationController_1.getApplications);
apiRoutes.post('/applications', auth_1.authenticateToken, applicationController_1.createApplication);
// 5. Clientes / Instituições
apiRoutes.get('/clients', clientController_1.getClients);
apiRoutes.post('/clients', auth_1.authenticateToken, clientController_1.createClient);
